...
import {
	...
	listEvents,
	normaliseEvents,
} from "../../src/_lib/google-calendar.js";

// The Google half of the events page: what the transport ASKS for, how it walks
// pages, and what the normaliser makes of the answer. Nothing here formats a
// date or knows what "now" is — that is src/_lib/event-display.js.
//
...
test("the event's own zone wins, else the calendar's, else undefined", () => {
	...
	// No default — "Europe/London" is annie-elliot's truth, not this module's,
	// and it lives in src/_data/calendar.js.
